...
const mbike = new bike_1.Bike('mountain bike', 'mountain', 123, 500, 100.5, 'desc', 5, []);
const maria = new user_1.User('Maria', 'maria@mail.com', '1234');
const sbike = new bike_1.Bike('speed bike', 'speed', 456, 250, 90.5, 'desc', 4, []);
const joao = new user_1.User('João', 'joao@mail.com', '5678');
...
app.rentBike(app.bikes[app.bikes.findIndex(rBike => { return rBike.name === 'speed bike'; })].id, 'joao@mail.com', sevenDaysAgo, twoDaysAgo);
