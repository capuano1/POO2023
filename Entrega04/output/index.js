...
const sinon_1 = __importDefault(require("sinon")); //=> fake timers, para testes
/*
const app = new App
...
/*async*/ function main() {
    let clock = sinon_1.default.useFakeTimers();
    ...
    const bike = new bike_1.Bike('Caloi Mountain', 'Mountain', 1234, 1234, 100.0, 'My Bike', 5, []);
    app.addBike(bike);
